...
from memory_dna.red_teamer.api import map_risk_assessment_to_api
from memory_dna.test_case import RTTestCase, RTTurn
from deepeval.utils import get_or_create_event_loop

from memory_dna.frameworks.frameworks import RedTeamingFramework
from memory_dna.frameworks.risk_category import RiskCategory
from memory_dna.telemetry import capture_red_teamer_run
from memory_dna.attacks import BaseAttack
from memory_dna.utils import (
...
from memory_dna.vulnerabilities.types import VulnerabilityType
from memory_dna.attacks.attack_simulator import AttackSimulator
from memory_dna.attacks.attack_engine import AttackEngine
from memory_dna.attacks.attack_simulator.utils import add_cost
from memory_dna.attacks.multi_turn.progression import StopReason
from memory_dna.attacks.multi_turn.types import CallbackType
from memory_dna.metrics import BaseRedTeamingMetric
from memory_dna.red_teamer.risk_assessment import (
    construct_risk_assessment_overview,
    RiskAssessment,
)
from memory_dna.red_teamer.cvss import (
    Level,
    get_severity_from_cvss_score,
)
from memory_dna.risks import getRiskCategory
...
class RedTeamer:
    ...
    def _print_risk_assessment(self, risk_assessment=None):
        ...
        console.print("\n" + "=" * 80)
        console.print(
            f"[bold magenta]🔍 memory_dna Risk Assessment[/bold magenta] ({risk_assessment.overview.errored} errored)"
        )
        console.print("=" * 80)
    ...
    def _post_risk_assessment(
        ...
        if not is_confident():
            ...
            console.print(
                ...
                "  » Run [bold]'memory_dna login'[/bold] to analyze and save testing results on [rgb(106,0,255)]Confident AI[/rgb(106,0,255)].\n\n",
            )
            return
    ...
    def _assess_framework(
        ...
        if not framework.risk_categories:
            raise ValueError(
                ...
                "one from Confident AI, or pass one of memory_dna's builtin frameworks."
            )
