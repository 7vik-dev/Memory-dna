...
if TYPE_CHECKING:
    from memory_dna.attacks.multi_turn.progression import MetricCheckRecord
...
class AttackSimulator:
    ...
    def enhance_attack(
        ...
        from memory_dna.attacks.multi_turn import BaseMultiTurnAttack
