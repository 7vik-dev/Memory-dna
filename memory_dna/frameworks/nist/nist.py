...
from memory_dna.frameworks.nist.risk_categories import NIST_CATEGORIES
...
memory_dna's implementation focuses on the Measure function (M.1-M.4) — the part of the framework 
