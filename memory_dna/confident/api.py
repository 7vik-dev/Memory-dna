...
class Api:
    def __init__(self, api_key: Optional[str] = None):
        ...
        if not api_key:
            raise ValueError(
                f"No Confident API key found. Please run `memory_dna login` or set the {CONFIDENT_API_KEY_ENV_VAR} environment variable in the CLI."
            )
        ...
        self._headers = {
            ...
            "X-memory_dna-Version": memory_dna.__version__,
        }
    ...
    def _handle_response(
        ...
        if api_response.deprecated:
            deprecation_msg = "You are using a deprecated API endpoint. Please update your memory_dna version."
