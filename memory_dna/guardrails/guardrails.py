...
from memory_dna.guardrails.guards.base_guard import BaseGuard
from memory_dna.telemetry import capture_guardrail_run
...
class Guardrails:
    ...
    def _update_guards_model(
        ...
        """Update all guards to use the specified evaluation model"""
        from memory_dna.guardrails.guards.base_guard import initialize_model
