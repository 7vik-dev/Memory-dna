...
from memory_dna.frameworks import RedTeamingFramework
...
memory_dna's EU AI Act module operationalises two of the central risk tiers of the Act so you
...
- Vulnerabilities: memory_dna vulnerability classes whose behaviours correspond to the article
...
class EUAIAct(RedTeamingFramework):
    ...
    description = "A risk-based AI regulation operationalised in memory_dna across Article 5 prohibited practices (subliminal manipulation, exploitation of vulnerabilities, social scoring, biometric categorisation, real-time and post remote biometric identification) and Annex III high-risk AI systems (biometric identification, critical infrastructure, education, employment, essential services, law enforcement, migration/border control, and administration of justice and democracy)."
    ALLOWED_TYPES = [
